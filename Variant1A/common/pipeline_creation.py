...
def codeblock_init_Q_support_params(self):
    self.Q_support_params, self.err_support_params = qval.helper_init_Q_support_params(self.Q_support_params, self.err_support_params)
...
def codeblock_init_Q_df(self):
    self.Q_df, self.err_df = qval.helper_init_Q_df(self.channels,self.Q_df_set, self.err_df_set)

def codeblock_update_Q_df(self):
    self.Q_df, self.err_df, self.Q_support_params, self.dpmndefaults, self.stop_amplitude_new = qval.helper_update_Q_df(self.Q_df, self.err_df, self.Q_support_params, self.dpmndefaults,pl.trial_num)
...
def create_q_val_pipeline(pl):
    ...
    #qvalues.py
    (q_val_pipe.Q_support_params, q_val_pipe.err_support_params) = q_val_pipe[qval.helper_init_Q_support_params](pl.Q_support_params, pl.err_support_params).shape(2)
    (q_val_pipe.Q_df, q_val_pipe.err_df) = q_val_pipe[qval.helper_init_Q_df](pl.actionchannels,pl.Q_df_set, pl.err_df_set).shape(2)
