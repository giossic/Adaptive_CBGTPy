...
def helper_update_Q_df(actionchannels, Q_df, err_df, Q_support_params, err_support_params, dpmndefaults, trial_num, current_RT, target_RT, timeout_RT, scale_power, scale_factor_stop, magnitude_da_stop_scaling_factor, max_stop_amplitude, stop_list_trials_list, stop_amp, stop_iter):
    ...
    if trial_num not in stop_list_trials_list:
        ...
        da_inc_stop = - error_exp_updated * 0.001 * magnitude_da_stop_scaling_factor
