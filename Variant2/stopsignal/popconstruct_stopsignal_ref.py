...
def helper_popconstruct(
    ...
    popdata = ModifyViaSelector(popdata, channels, SelName(
        ['GPi', 'STN', 'GPeP','GPeA', 'dSPN', 'iSPN', 'Cx', 'CxS', 'Th']))
...
def helper_poppathways(popdata,number_of_choices, newpathways=None):
    ...
    simplepathways = pd.DataFrame(
        [
            ['Cx', 'dSPN', 'AMPA', 'syn', 1, 0.028, True], #0.022
            ['Cx', 'dSPN', 'NMDA', 'syn', 1, 0.030, False], 
            ['Cx', 'iSPN', 'AMPA', 'syn', 1, 0.028, True], #0.022
            ...
            #['CxS', 'STN', 'AMPA', 'syn', 1, 0.03, False], 
            #['CxS', 'STN', 'NMDA', 'syn', 1, 0.035, False],
            ['CxS', 'STN', 'AMPA', 'syn', 1, 0.023, False], #0.034
            ['CxS', 'STN', 'NMDA', 'syn', 1, 0.027, False], #0.042
            ['CxS', 'GPeA', 'AMPA', 'syn', 1, 0.027, False], #0.020 #0.048 #0.027  # max 0.036 min. 0.020 step 0.002 -> 9 valores # prob 0.5 a 1 -> 6 valores    #prob = 1
            ['CxS', 'GPeA', 'NMDA', 'syn', 1, 0.032, False], #0.025 #0.049 #0.032
            ['CxS', 'iSPN', 'AMPA', 'syn', 1, 0.027, False], #0.048
            ['CxS', 'iSPN', 'NMDA', 'syn', 1, 0.034, False], #0.045
           
            #['CxS', 'GPeA', 'AMPA', 'syn', 0.63, 0.034, False], 
            #['CxS', 'GPeA', 'NMDA', 'syn', 0.58, 0.042, False],
...
#             ['STN', 'GPi', 'NMDA', 'all', 1, 0.0325, False], 
            ...
            ['GPi', 'Th', 'GABA', 'syn', 1, 0.305, False], #0.32 #0.3315
...
#             ['Th', 'Cx', 'NMDA', 'all', 0.8334, 0.03, False],
            ...
            ['Cx', 'CxI', 'AMPA', 'all', 0.05*scaling_conn, 0.113*scaling_wts, False],
            ['Cx', 'CxI', 'NMDA', 'all', 0.05*scaling_conn, 0.525*scaling_wts, False],
            #['Cx', 'CxI', 'AMPA', 'all', 0.0725*scaling_conn, 0.113*scaling_wts, False],
            #['Cx', 'CxI', 'NMDA', 'all', 0.0725*scaling_conn, 0.525*scaling_wts, False],

            ['CxS', 'CxS', 'AMPA', 'syn', 0.13, 0.0127, False], 
            ['CxS', 'CxS', 'NMDA', 'syn', 0.13, 0.1, False], 
            ['CxS', 'CxI', 'AMPA', 'all', 0.05*scaling_conn, 0.113*scaling_wts, False],
            ['CxS', 'CxI', 'NMDA', 'all', 0.05*scaling_conn, 0.525*scaling_wts, False],
            #['CxS', 'CxI', 'AMPA', 'all', 0.0725*scaling_conn, 0.113*scaling_wts, False],
            #['CxS', 'CxI', 'NMDA', 'all', 0.0725*scaling_conn, 0.525*scaling_wts, False],

            
            ['CxI', 'Cx', 'GABA', 'all', 0.5, 1.05, False],
            #['CxI', 'CxS', 'GABA', 'all', 0.5, 1.05, False], Removed 10/1/2025 CG
