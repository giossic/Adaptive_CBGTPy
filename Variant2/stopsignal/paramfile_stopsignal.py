...
popspecific = {'Cx': {'N': 204, 'dpmn_cortex': 1}, #1
               'CxS': {'N': 204, 'dpmn_cortex_stop': 0},
               'FSI': {'C': 0.2, 'Taum': 10},
...
d1defaults = {'dpmn_type': 1, #1
              'dpmn_alphaw': 12, #15 #39.5
              # 'dpmn_alphaw': (55 / 3.0)*3,  # ??? 80 in original paper, balladron 12, decrease them
              # 'dpmn_alphaw': 12.,
              'dpmn_wmax': 0.055, #0.055
              'dpmn_a': 1.0,
              'dpmn_b': 0.1,
              'dpmn_c': 0.05, }

d2defaults = {'dpmn_type': 2, #2
              'dpmn_alphaw': -11, #-11    #15.7 #-28 #-30 #alphaw_stop
              'dpmn_alphaw_stop': .1, #.02
              'dpmn_wmax': 0.055, #0.035
              'dpmn_wmax_stop': 0.18, #0.35
              'dpmn_a': 0.5,
              'dpmn_b': 0.005,
              'dpmn_c': 0.05, }
