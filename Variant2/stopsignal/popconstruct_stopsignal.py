...
def helper_poppathways(popdata,number_of_choices, newpathways=None):
    ...
    simplepathways = pd.DataFrame(
        [
            ['Cx', 'dSPN', 'AMPA', 'syn', 1, 0.028, True], #0.028 ref
            ['Cx', 'dSPN', 'NMDA', 'syn', 1, 0.030, False], 
            ['Cx', 'iSPN', 'AMPA', 'syn', 1, 0.028, True], #0.028 ref
            ...
            ['CxS', 'STN', 'AMPA', 'syn', 1, 0.20, False], #0.20
            ['CxS', 'GPeA', 'AMPA', 'syn', 1, 0.09, False], #0.09
            ['CxS', 'iSPN', 'AMPA', 'syn', 1, 0.13, False], #0.13 
            
            
            #['CxS', 'STN', 'NMDA', 'syn', 1, 0, False], #0.027
            #['CxS', 'GPeA', 'NMDA', 'syn', 1, 0.032, False], #0.032
            #['CxS', 'iSPN', 'NMDA', 'syn', 1, 0.034, False], #0.034
...
#             ['STN', 'GPi', 'NMDA', 'all', 1, 0.0325, False], 
            ...
            ['GPi', 'Th', 'GABA', 'syn', 1, 0.32, False], #0.305 #0.31 #0.32 #0.3315
